    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            ->add('noms', TextType::class,[
                'label' => $this->translator->trans('Nom de l\'agent'),
                'attr' => [
            ...
            ->add('typeActeDet', ChoiceType::class,[
                'label' => 'Type acte',
                'choices' => [
                    $this->translator->trans('Arrêté') => 'ARRETE',
                    $this->translator->trans('Décret') => 'DECRET',
                    $this->translator->trans('Elu') => 'ELU',
                    $this->translator->trans('Décision') => 'DECISION'
                ]
            ])
            ...
            ->add('ministere', ChoiceType::class, [
                'label' => $this->translator->trans('Ministère d\'origine'),
                'choices' => [
                    'PRC' => '01',
                    'MINRA' => '02',
                    'SPM' => '03',
            ...
            ->add('refActeDet', TextType::class,[
                'label' => $this->translator->trans('Référence de l\'acte'),
                'attr' => [
            ...
            ->add('dateDet', DateType::class, [
                'label' => $this->translator->trans('Date de détachement'),
                'widget' => 'single_text'])
            ->add('dateSuspension',DateType::class, [
                'label' => $this->translator->trans('Date de suspension solde'),
                'widget' => 'single_text'])
            ->add('datePriseService', DateType::class, [
                'label' => $this->translator->trans('Prise de service organisme'),
                'widget' => 'single_text'])
